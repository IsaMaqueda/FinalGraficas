...
THREE.ThirdPersonControls = function ( player, camera, domElement ) {
    ...
    //this.camera.position.y = player.position.y + 1
    //this.camera.position.z = player.position.z + this.distance

    this.player.add(camera)

    this.camera.position.set(0,75,250)
	...
	this.update = function () {
		...
		return function update( delta ) {
            ...
            //this.camera.position.z = targetPosition.z - this.distance
